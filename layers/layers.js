...
lyr_GrmNovomestocenterbiotehnikeinturizma_1.set('fieldLabels', {'id': 'hidden field', 'SLO Ime': 'no label', 'ENG Ime': 'no label', 'Številka': 'hidden field', 'Label': 'hidden field', 'foto': 'no label', 'povezava': 'no label', });
