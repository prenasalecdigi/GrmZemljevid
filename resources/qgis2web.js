...
map.getView().fit([1690448.261721, 5753025.986669, 1692079.467532, 5754397.060137], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Grm Novo mesto - center biotehnike in turizma</h2>';
        return titleElement;
    })(),
